...
_C.AVA.FRAME_DIR = "/nfs/cold_project/jinzhao/OTW/homes/frames/"

# Directory path for files of frame lists.
_C.AVA.FRAME_LIST_DIR = (
    "/home/luban/slowfast/conversion/"
)
...
_C.AVA.TEST_LISTS = ["test.csv"]

# Filenames of box list files for training. Note that we assume files which
# contains predicted boxes will have a suffix "predicted_boxes" in the
# filename.
_C.AVA.TRAIN_GT_BOX_LISTS = ["otw_train_predicted_boxes.csv"]
_C.AVA.TRAIN_PREDICT_BOX_LISTS = []

# Filenames of box list files for test. #doesnt work
_C.AVA.TEST_PREDICT_BOX_LISTS = ["222otw_val_predicted_boxes.csv"]
...
_C.AVA.FULL_TEST_ON_VAL = True

# The name of the file to the ava label map.
_C.AVA.LABEL_MAP_FILE = "otw_action_list.pbtxt"

# The name of the file to the ava exclusion.
_C.AVA.EXCLUSION_FILE = "None"

# The name of the file to the ava groundtruth.
_C.AVA.GROUNDTRUTH_FILE = "otw_val_predicted_boxes.csv"
